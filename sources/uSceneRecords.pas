...
uses SysUtils, Graphics, uUtils, uGraph, uSceneMenu, uScenes, uColor,
  uError, uBox, uLang, uGame;
...
begin
  ...
  try
    ...
    on E: Exception do Error.Add('SceneRecords.KeyDown (#' + IntToStr(Key) + ')', E.Message);
  end;
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        TextOut(Graph.Width - (K[0] + Graph.CharWidth), Graph.CharHeight * 2, GetLang(N[0]));
      end;
      // Col Value
      for I := 0 to Max do
      begin
        ...
        TextOut(Graph.Width - (K[0] + Graph.CharWidth), Y, Game.Scores.GetValue(0, I));
        Font.Style := [];
        Inc(R);
      end;
    end;
    ...
    on E: Exception do Error.Add('SceneRecords.Render', E.Message);
  end;
end;
