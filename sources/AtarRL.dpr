...
{ 
[16:18:10] Konstantin Ramenskii: 10 старт. игрок получает хелп с тем, что он 
20 игрок в комнате с возможностью купить предметы (оружие, броня и применялки, типа лечилка +100500 хп, но один раз, пояс дающий + 1 используемы предмет итд тут вариантов много)
30 игрок подходит к порталам. Там 2-3 от Большой приз+рваная жопа до маленький приз+целая жопа.
40 бьётся в портале.
50 Если умер Гейм Овер (для первой версии хватит)
60 победил всех, открывается портал в комнату героя.
70 Приз + Н монет и возможный лут на арене(под вопросом, чтобы игроку не нужно было облазевать всё).
80 GoTo 20
}
