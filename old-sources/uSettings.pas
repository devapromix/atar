...
type
  ...
  public
    ...
    function Read(const Section, Ident: string; Default: Integer): Integer; overload;
    function Read(const FileName, Section, Ident, Default: string): string; overload;
    function Read(const FileName, Section, Ident: string; Default: Integer): Integer; overload;
    ...
    procedure Write(const FileName, Section, Ident: string; Value: Integer); overload;
  end;

implementation

uses IniFiles, uUtils, uGraph, uCreatures;
...
function TSettings.Read(const Section, Ident: string;
