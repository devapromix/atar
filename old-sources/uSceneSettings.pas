...
uses Graphics, SysUtils, uGraph, uColor, uScenes, uMain, uSceneMenu, uError,
  uUtils, uLang, uSettings, uBox;
...
begin
  ...
  try
    ...
    on E: Exception do Error.Add('SceneSettings.KeyDown (#' + IntToStr(Key) + ')', E.Message);
  end;
end;
...
begin
  try
    ...
    on E: Exception do Error.Add('SceneSettings.SettingsItem', E.Message);
  end;
end;
...
begin
  ...
  try
    ...
    on E: Exception do Error.Add('SceneSettings.Render', E.Message);
  end;
end;
